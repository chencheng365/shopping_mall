          ...
          <li>
            <div class="cart-tab-1">
              <div class="cart-item-check">
                <a href="javascipt:;" class="checkbox-btn item-check-btn" v-bind:class="{'check':isCheck}" @click="edit">
            ...
            <div class="cart-tab-5">
              <div class="cart-item-opration">
                <a href="javascript:;" class="item-edit-btn" @click="delCartConfirm">
    ...
    <div class="cart-foot-wrap">
      <div class="cart-foot-inner">
        ...
        <div class="cart-foot-r">
          ...
          <div class="btn-wrap">
            <a class="btn btn--red" v-bind:class="{'btn--dis':!isCheck}" @click="checkOut">Checkout</a>
          </div>
        </div>
      </div>
    </div>
